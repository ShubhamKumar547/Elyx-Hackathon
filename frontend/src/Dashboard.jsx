                      ...
                      <ResponsiveContainer width="100%" height={300}>
                        <PieChart>
                          <Pie
                            ...
                            animationDuration={1500}
                          >
                            {healthData.analytics.distribution.map(
                              (entry, index) => (
                                <Cell
                                  key={`cell-${index}`}
                                  fill={entry.color}
              ...
              <div className="trends-card">
                <h3>
                  {activeTrendTab === "monthly"
                    ? "6-Month Health Progress"
                    : "4-Week Health Progress"}
                </h3>
                <div className="chart-container">
                  <ResponsiveContainer width="100%" height={400}>
                    <AreaChart
                    ...
                    >
                      ...
                      <XAxis
                        dataKey={
                          activeTrendTab === "monthly" ? "month" : "week"
                        }
                        tick={{ fill: "#666" }}
                      />
                      <YAxis domain={[50, 100]} tick={{ fill: "#666" }} />
                      <Tooltip
                        contentStyle={{
                          background: "rgba(255, 255, 255, 0.96)",
                          borderRadius: "8px",
              ...
              <div className="trends-insights">
                ...
                <div className="insights-grid">
                  <div className="insight-card">
                    ...
                    <p>
                      Your health score has increased by{" "}
                      <strong>16 points</strong> over the last
                      {activeTrendTab === "monthly" ? " 6 months" : " 4 weeks"},
                      showing consistent positive trend.
                    </p>
                  </div>
